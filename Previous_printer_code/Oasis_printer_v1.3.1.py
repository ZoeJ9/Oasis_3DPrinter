...
# CAMERA SETTINGS — 175mm 베드 셋업에서 검증된 값
# ============================================================
CAMERA_INDEX          = 0
BACKEND               = _cv2_global.CAP_DSHOW

RESOLUTION_FULL       = (8000, 6000)   # 48MP, ~1.3 fps, MJPEG 필수
RESOLUTION_PREVIEW    = (1920, 1080)   # 빠른 미리보기 / 포커싱용, 30 fps
...
AVERAGING_FRAMES      = 10            # 노이즈 감소 (1이면 끔)
UNSHARP_SIGMA         = 2.5
UNSHARP_AMOUNT        = 1.2           # 0이면 샤프닝 끔
# ============================================================
    ...
    def _PrintSVG_inner(self):
        ...
        if (
            ...
            if hasattr(self, "camera_window"):
                ...
                self.camera_window.capture_sync("Layer_000_Spread")
