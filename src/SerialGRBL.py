...
class GRBL(serial.Serial):
    def __init__(self):
        ...
        self.printer_size_x = 480 #475 #480 #x total size #originally 480 
        self.printer_size_y = 250 #260 #250.0 #y total size
        self.printer_size_f = 100.0 #feed hopper total size
        self.printer_size_b = 100.0 #build hopper total size
        
        self.spreader_state = 0
        
        self.nl_back_pos_x = 80 #80.0 #where x starts feeding
        self.nl_back_pos_y = 240 #240.0 #where y starts and ends while feeding
        self.nl_front_pos_x = 420.0 #where x ends OG 475
