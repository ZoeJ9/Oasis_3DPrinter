    ...
    def _PrintSVG_inner(self):
        ...
        if (
            ...
            while True:
                ...
                # Flush HP45 serial buffers each layer to prevent Windows driver buffer accumulation
                # over long prints (typically seen after 50-70 layers)
                try:
                    self.inkjet.ser.reset_input_buffer()
                    self.inkjet.ser.reset_output_buffer()
                except Exception:
                    pass
